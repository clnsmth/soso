...
def test_personFormat_returns_expected_value():
    ...
    givenName = "John H."
    familyName = "Smith"
    assert personFormat(type, roleName, name, givenName, familyName, firstEntry=True) == (
    ...
    givenName = "Mark L."
    familyName = "Watney"
    assert personFormat(type, roleName, name, givenName, familyName) == (
        {"@type": "Person",
            "name": "Mark L. Watney",
            "givenName": "Mark L.",
            "familyName": "Watney"})
...
def test_get_measurementMethod_returns_expected_value():
    ...
    assert get_measurementMethod(spase) == [
        ...
        "inDefinedTermSet": {
            ...
            "url": "https://spase-group.org/data/model/spase-latest/spase-latest_xsd.htm#MeasurementType"
        },
    ...
    assert get_is_part_of(spase, **kwargs) == {
        ...
        "creator": {
            ...
            "affiliation": {
                ...
                "name": "Department of Physics and Space Sciences, Florida Institute of Technology"
            },
            "familyName": "Zhang",
            "givenName": "Ming",
            "name": "Zhang, Ming"
        ...
        "description": "This Data Set contains 10 min Average Ion and Electron Spin-Averaged Coincidence Counting Rates from the COSPIN High Energy Telescope (HET). The Parameter Keys in the Parameter Level Segments below are specifically relevant to the UFA accessible Versions of the Data.",
        "identifier": "https://doi.org/10.48322/s9mg-he04",
        "name": "Ulysses Cosmic Ray and Solar Particle Investigation (COSPIN) High Energy Telescope (HET) Ion and Electron Spin-Averaged Coincidence Counting Rates, 10 min Data",
...
def test_verifyType_returns_expected_value():
    ...
    assert verifyType(url) == (False, False, {})
...
def test_updateLog_returns_expected_value():
    ...
    updateLog(cwd, "testRepo", "requiredRepos")
    ...
    # return None.
    assert updateLog(None, None, None) is None